...
public class VisibleMatrix4f
{
	...
	public static Matrix4f exportMatrix(VisibleMatrix4f visibleMat)
	{
	...
	public static VisibleMatrix4f importMatrix(Matrix4f mat4f)
	{
		FloatBuffer buf = BufferUtils.createFloatBuffer(16);
		buf.position(0);
		mat4f.write(buf);
		return VisibleMatrix4f.load(null, buf);
	}
}