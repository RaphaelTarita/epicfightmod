...
public class ModRenderTypes extends RenderType {
	...
	public static RenderType getEyes(ResourceLocation locationIn) {
		...
		return makeType(EpicFightMod.MODID + ":eyes", DefaultVertexFormats.ENTITY, GL11.GL_TRIANGLES, 256, false, false, state);
	}
	...
	public static RenderType getBoundingBox() {
		...
		return makeType(EpicFightMod.MODID + ":bounding_box", DefaultVertexFormats.POSITION_COLOR, GL11.GL_LINE_STRIP, 256, false, false, state);
	}
