...
public class AimHelperRenderer
{
	public void doRender(MatrixStack matStackIn, float partialTicks)
	{
		...
		bufferBuilder.pos(matrix, pos1.x, pos1.y, pos1.z).color(0.0F, 1.0F, 0.0F, 0.5F).endVertex();
		bufferBuilder.pos(matrix, pos2.x, pos2.y, pos2.z).color(0.0F, 1.0F, 0.0F, 0.5F).endVertex();
