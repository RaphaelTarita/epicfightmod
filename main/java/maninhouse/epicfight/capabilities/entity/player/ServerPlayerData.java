...
public class ServerPlayerData extends PlayerData<ServerPlayerEntity> {
	...
	public void onHeldItemChange(CapabilityItem toChange, ItemStack stack, Hand hand) {
		...
		if (hand == Hand.MAIN_HAND) {
			...
			this.orgEntity.getAttribute(Attributes.ATTACK_SPEED).applyNonPersistentModifier(new AttributeModifier(WEIGHT_PENALTY_MODIFIIER, "weight penalty modifier",
			...
			this.orgEntity.getAttribute(ModAttributes.OFFHAND_ATTACK_SPEED.get()).applyNonPersistentModifier(new AttributeModifier(WEIGHT_PENALTY_MODIFIIER, "weight penalty modifier",
					Formulars.getAttackSpeedPenalty(this.getWeight(), weaponSpeed, this), Operation.ADDITION));
	...
	public void onArmorSlotChanged(CapabilityItem fromCap, CapabilityItem toCap, EquipmentSlotType slotType) {
		...
		mainhandAttackSpeed.applyNonPersistentModifier(new AttributeModifier(WEIGHT_PENALTY_MODIFIIER, "weight penalty modifier",
		...
		offhandAttackSpeed.applyNonPersistentModifier(new AttributeModifier(WEIGHT_PENALTY_MODIFIIER, "weight penalty modifier",
