...
import maninhouse.epicfight.animation.types.attack.AAAnimation;
import maninhouse.epicfight.animation.types.attack.AADashAnimation;
...
import maninhouse.epicfight.animation.types.attack.SpecialAttackAnimation;
...
public final class Animations
{
	...
	public static void registerAnimations(Dist dist)
	{
		...
		GREATSWORD_DASH = new AADashAnimation(2011, 0.11F, 0.4F, 0.65F, 0.8F, 1.2F, null, "111213", "biped/combat/greatsword_dash.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);
		...
		SPEAR_MOUNT_ATTACK = new MountAttackAnimation(2245, 0.16F, 0.38F, 0.38F, 0.45F, 0.8F, null, "111213", "biped/combat/spear_mount_attack.dae").bindFull(biped);
		
		BIPED_ARMED_MOB_ATTACK1 = new TargetTraceAnimation(2900, 0.08F, 0.45F, 0.55F, 0.65F, 0.95F, false, null, "111213", "biped/combat/armed_mob_attack1.dae").bindFull(biped);
		BIPED_ARMED_MOB_ATTACK2 = new TargetTraceAnimation(2901, 0.08F, 0.45F, 0.55F, 0.65F, 0.95F, false, null, "111213", "biped/combat/armed_mob_attack2.dae").bindFull(biped);
		...
		ENDERMAN_GRASP = new TargetTraceAnimation(3015, 0.06F, 0.5F, 0.45F, 1.0F, 1.0F, false, Colliders.endermanStick, "111213", "enderman/grasp.dae").bindFull(enderman);
		...
		GOLEM_ATTACK3 = new TargetTraceAnimation(3202, 0.16F, 0.4F, 0.4F, 0.5F, 0.9F, false, Colliders.golemSwingArm, "11131", "iron_golem/attack3.dae").bindFull(iron_golem);
		GOLEM_ATTACK4 = new TargetTraceAnimation(3203, 0.16F, 0.4F, 0.4F, 0.5F, 0.9F, false, Colliders.golemSwingArm, "11121", "iron_golem/attack4.dae").bindFull(iron_golem);
		...
		WITHER_SKELETON_ATTACK1 = new TargetTraceAnimation(3500, 0.16F, 0.31F, 0.31F, 0.41F, 0.7F, false, Colliders.swordDash, "111213", "skeleton/wither_skeleton_attack1.dae").bindFull(biped);
		WITHER_SKELETON_ATTACK2 = new TargetTraceAnimation(3501, 0.16F, 0.31F, 0.31F, 0.41F, 0.7F, false, Colliders.sword, "111213", "skeleton/wither_skeleton_attack2.dae").bindFull(biped);
		WITHER_SKELETON_ATTACK3 = new TargetTraceAnimation(3502, 0.16F, 0.31F, 0.31F, 0.41F, 0.7F, false, Colliders.sword, "111213", "skeleton/wither_skeleton_attack3.dae").bindFull(biped);
